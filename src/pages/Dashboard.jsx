...
export default function Dashboard() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Dikirim fresh dalam 1-2 hari',
    },
  ];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in-up">
              <Badge className="bg-cream/20 text-cream border-cream/30 w-fit">
                ☕ Kopi Premium Nusantara
              </Badge>
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                Nikmati Kopi<br />Berkualitas Tinggi
              </h1>
              <p className="text-lg sm:text-xl text-cream/90 leading-relaxed">
                Dari biji pilihan terbaik hingga secangkir kopi sempurna.
                Rasakan pengalaman kopi autentik Indonesia.
              </p>
            ...
            <div className="hidden md:block">
              <img
                src="https://images.unsplash.com/photo-1608552265232-3a1e3feb0271?w=800&q=80"
                alt="Coffee brewing"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Koleksi kopi premium kami yang paling diminati pelanggan
            </p>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-warm rounded-3xl p-8 md:p-12 text-center text-primary-foreground shadow-elegant">
            <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4">
              Siap Menikmati Kopi Terbaik?
            </h2>
            <p className="text-lg mb-8 text-cream/90 max-w-2xl mx-auto">
              Pesan sekarang dan rasakan perbedaan kopi premium kami.
              Gratis ongkir untuk pembelian pertama!
            </p>
            <Link to="/produk">
              <Button size="lg" className="bg-cream text-coffee-dark hover:bg-cream/90">
                Mulai Belanja
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
